...
const showAlert = props => {
  ...
  Alert.alert(
    ...
    `Would you like to receive an update each day on the stats for ${
      specificCountry ? name : 'the entire world'
    }?`,
    [
      {
        text: 'Yes',
        onPress: () => console.log('todo: add notification subscription'),
      },
      {
        text: 'No',
        onPress: () => console.log('todo: absolutely nothing'),
        style: 'cancel',
      },
    ],
    {cancelable: true},
